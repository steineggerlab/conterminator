...
std::vector<struct Command> commands = {
        ...
        {"distanceton",      distanceton,      &localPar.distanceton,          COMMAND_HIDDEN,
                "Compute the distance to next n in alignment",
                NULL,
                "Martin Steinegger <martin.steinegger@mpibpc.mpg.de>",
                "<i:queryDB> <i:targetDB> <i:alnDB> <o:alnDB>", CITATION_MMSEQS2,
                {{"queryDB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::taxSequenceDb },
